  ...
  async createOrRetrieve() {
    ...
    const update = {
      $setOnInsert: {
        ...
        gridSquare:this.gridsquare,//we appear to have 2 fields here that have the same meaning
    ...
    if (dbrecord.notes) {
      this.notes.length=0
        ...
        //We coudl do this as a single find() and then sort to match the array
